...
class _WeatherState extends State<Weather> {
  ...
  void initState() {
    super.initState();
    String
    url='https://samples.openweathermap.org/data/2.5/forecast?q=${this.widget.city}&appid=b6907d289e10d714a6e88b30761fae22';
    print(url);
    this.getData(url);
  }
  @override
    ...
    return Scaffold(
        ...
        ListView.builder(
            ...
            itemBuilder: (context,index){
              ...
              Text("${f.format(DateTime.fromMicrosecondsSinceEpoch(weatherData[index]['dt']*1000000))}",
